...
![](https://picture-transmission.iplus-studio.top/Snipaste_2020-12-26_16-33-33.png)
...
![](https://picture-transmission.iplus-studio.top/Snipaste_2020-12-26_16-41-00.png)

2. 点击Stop。DevTools停止记录，处理数据，展示结果。

![](https://picture-transmission.iplus-studio.top/Snipaste_2020-12-26_16-43-01.png)

3. 展现数据

![](https://picture-transmission.iplus-studio.top/Snipaste_2020-12-26_16-44-28.png)

# 分析（重点）

![](https://picture-transmission.iplus-studio.top/Snipaste_2020-12-26_16-51-24.png)

## 桢率

![](https://picture-transmission.iplus-studio.top/Snipaste_2020-12-26_16-55-27.png)

注意看FPS表，如果你看到了一条红色的条条在FPS上方，这证明你的帧速率掉得太低了，已经影响到了用户体验了。总的来说，绿色的条条越高，你的帧速率就越高。

## CPU

![](https://picture-transmission.iplus-studio.top/Snipaste_2020-12-26_16-57-20.png)
...
![](https://picture-transmission.iplus-studio.top/Snipaste_2020-12-26_17-00-18.png)

在FPS，CPU，NET任意表上移动鼠标，你将看到那个事件点的页面快照，这叫scrubbing，可以用于手动计算动画的进展.

## Frames

![](https://picture-transmission.iplus-studio.top/Snipaste_2020-12-26_17-03-15.png)
...
![](https://picture-transmission.iplus-studio.top/Snipaste_2020-12-26_17-08-41.png)

2. 展开Main图表，Devtools展示了主线程运行状况。X轴代表着时间。每个长条代表着一个event。长条越长就代表这个event花费的时间越长。Y轴代表了调用栈（call
   stack）。在栈里，上面的event调用了下面的event。

![](https://picture-transmission.iplus-studio.top/Snipaste_2020-12-26_17-12-28.png)
...
![](https://picture-transmission.iplus-studio.top/Snipaste_2020-12-26_17-16-05.png)
...
![](https://picture-transmission.iplus-studio.top/Snipaste_2020-12-26_17-17-47.png)
...
![](https://picture-transmission.iplus-studio.top/Snipaste_2020-12-26_17-06-48.png)
