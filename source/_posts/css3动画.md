...
一个在线调试贝塞尔曲线的网站：[cubic-bezier.com](https://cubic-bezier.com/#.17,.67,.83,.67)。
...
![](https://picture-transmission.iplus-studio.top/16ac0310ff7ba99a.gif)

设置动画延迟 1s 后执行，且填充模式为 `backwards` 时，可以看到动画在开始前是处于 100px 处，动画结束后回到 0px 处：

![](https://picture-transmission.iplus-studio.top/16ac035a53f40b08.gif)

最后设置填充模式为 `both` 的情形：

![](https://picture-transmission.iplus-studio.top/16ac0380ae444be8.gif)
...
![](https://picture-transmission.iplus-studio.top/16ac0435e14da43a.gif)
...
![](https://picture-transmission.iplus-studio.top/16ac04adc7f87ab6.gif)

### animation-play-state

CSS 动画是可以暂停的。属性 animation-play-state 表示动画播放状态，默认值 `running` 表示播放， `paused` 表示暂停

![](https://picture-transmission.iplus-studio.top/16ac050679097040.gif)
